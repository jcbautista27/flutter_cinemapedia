...
class MovieHortizontalListview extends StatefulWidget {
  ...
  const MovieHortizontalListview({
    Key? key, 
  ...
  @override
  State<MovieHortizontalListview> createState() => _MovieHortizontalListviewState();
}

class _MovieHortizontalListviewState extends State<MovieHortizontalListview> {
